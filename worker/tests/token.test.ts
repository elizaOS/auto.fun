...
describe("Token API Endpoints", () => {
  ...
  describe("WebSocket Token Streaming", () => {
    it("should connect to WebSocketDO and handle messages", async () => {
      ...
      const mockWebSocketPairConstructor = vi
        .fn()
        .mockImplementation(() => mockWebSocketPair);
      ...
      try {
        ...
        const messageEventListener =
          mockWebSocketPair[1].addEventListener.mock.calls.find(
            (call) => call[0] === "message",
          );
