...
export const raydiumProgramId = cluster.toString() == "mainnet-beta" ? MAINNET_PROGRAM_ID : DEVNET_PROGRAM_ID;
export const ammProgram = cluster.toString() == "mainnet-beta"
...
export const marketProgram = cluster.toString() == "mainnet-beta"
...
export const cpSwapProgramId = cluster.toString() == "mainnet-beta"
