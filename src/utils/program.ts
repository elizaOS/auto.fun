...
export const useProgram = () => {
  ...
  const program = useMemo(() => {
    ...
    console.log("IDL_DEV", IDL_DEV);
    console.log("IDL_PROD", IDL_PROD);

    const program = new Program<Autofun | AutofunProd>(
      env.solanaNetwork === "devnet" ? IDL_DEV : IDL_PROD,
      provider,
    );
