...
const useCreateTokenMutation = () => {
    return useMutation({
      ...
      mutationFn: async ({
        ...
        console.log('minting token', token_metadata.name,
          token_metadata.symbol,
          metadataUrl, token_metadata.tokenMint)
  ...
  export function useCreateToken() {
    ...
    const createToken = useCallback(
      async ({tokenMetadata, metadataUrl, mintKeypair}: {tokenMetadata: TokenMetadata, metadataUrl: string; mintKeypair: Keypair}) => {
