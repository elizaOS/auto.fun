  ...
  return (
    <Dialog open={open} onOpenChange={(op: boolean) => setOpen(op)}>
      <DialogTrigger onClick={() => setOpen(true)} asChild>
        <button className="cursor-pointer flex items-center justify-center px-3 py-2 gap-2 h-9 bg-transparent text-autofun-text-secondary hover:text-white transition-colors duration-200">
