...
const ConnectedWalletButton = ({
  ...
  return (
    <div className="h-11 justify-start items-center inline-flex relative">
      <div className="p-3 rounded-tl-xl rounded-bl-xl border-l border-t border-b border-[#33c55e] justify-center items-center gap-2 flex">
        ...
        <div className="text-[#33c55e] text-base font-medium font-['DM Mono'] leading-tight">
          {concatAddress}
        </div>
      </div>
      <button
        className="p-3 bg-[#040207] rounded-tr-xl rounded-br-xl border border-[#33c55e] justify-center items-center gap-2 flex"
        onClick={() => {
          if (!showDisconnect) {
