...
export function AgentCard({ name, image, ticker, mint, marketCapUSD, onClick }: AgentCardProps) {
  ...
  return (
    <div 
      onClick={onClick}
      className="flex flex-col gap-[12px] w-full max-w-[411.5px] h-auto min-h-[288px] p-4 bg-[#171717] border border-[#262626] rounded-[8px] cursor-pointer hover:border-[#2FD345]/50 transition-colors"
    >
      {/* Top container with image and details */}
      <div className="flex flex-col sm:flex-row gap-[12px] w-full">
        {/* Image */}
        <div 
          className="w-full sm:w-[120px] h-[127.5px] rounded-[4px] bg-cover bg-center shrink-0" 
          style={{
        ...
        <div className="flex flex-col gap-[12px] flex-1 min-w-0">
          ...
          <div className="flex justify-between items-start w-full h-[24px] flex-wrap gap-2">
            ...
            <div className="flex items-center gap-[4px] px-[8px] h-[24px] border border-[#262626] rounded-[6px] shrink-0">
          ...
          <div className="flex flex-col gap-[4px] w-full">
            <div className="flex justify-between items-center flex-wrap gap-2">
              ...
              <span className={`${dmMono.className} text-sm text-[#2FD345] shrink-0`}>28%</span>
            </div>
      ...
      <button className="flex justify-center items-center w-full h-[44px] px-5 bg-[#2E2E2E] border border-[#262626] rounded-[6px] text-white hover:bg-[#2FD345] hover:text-black transition-colors mt-auto">
        Buy
      </button>
    </div>
  );
