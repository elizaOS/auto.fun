...
export const WalletModal: FC<WalletModalProps> = ({ className = "" }) => {
  ...
  const handleCollapseClick = useCallback(async () => {
    ...
    <li key={wallet.adapter.name} className="flex w-full mb-2">
      ...
      >
        ...
        {wallet.readyState === WalletReadyState.Installed && (
          <div className="ml-2 py-1 px-2 text-xs bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100 rounded-full">
            Installed
          </div>
        )}
      </button>
                ...
                <div className="flex justify-center mb-6">
                  <div className="p-4">
                    <svg width="96" height="96" fill="none" viewBox="0 0 96 96">
                      ...
                      />
                      <path
                        d="M44 30C44 27.7909 45.7909 26 48 26H56C58.2091 26 60 27.7909 60 30V35.5C60 37.7091 61.7909 39.5 64 39.5H68C70.2091 39.5 72 41.2909 72 43.5V66C72 68.2091 70.2091 70 68 70H28C25.7909 70 24 68.2091 24 66V43.5C24 41.2909 25.7909 39.5 28 39.5H32C34.2091 39.5 36 37.7091 36 35.5V30Z"
                        fill="#512DA8"
                      />
                    </svg>
                  </div>
