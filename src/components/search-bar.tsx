...
export default function SearchBar() {
  ...
  return (
    <div className="relative">
      <div className="flex md:max-w-72 lg:max-w-96 items-center h-11 w-full px-2 gap-2 bg-[#171717] border border-[#262626] hover:border-[#2FD345]/50 focus-within:border-[#2FD345]/50 transition-colors">
