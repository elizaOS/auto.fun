...
export const WalletModal: FC<WalletModalProps> = ({ className = "" }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div
        className={`bg-white rounded-lg shadow-xl p-6 max-w-md w-full relative z-10 ${className}`}
      >
        <button
          onClick={hideModal}
          ...
          <>
            <div className="text-center mb-4">
              ...
              <div className="my-4 flex justify-center">
                ...
                >
                  <path
                    d="M80 25H20L40 50L20 75H80L60 50L80 25Z"
                    fill="#9945FF"
                  />
                </svg>
              </div>
          ...
          <>
            <div className="text-center mb-6">
              ...
              <div className="my-6 flex justify-center">
                ...
                >
                  ...
                  />
                  <path
                    d="M19 10H15C14.4477 10 14 10.4477 14 11V13C14 13.5523 14.4477 14 15 14H19V10Z"
                    stroke="white"
                    strokeWidth="1.5"
                  />
                </svg>
            ...
            {otherWallets.length > 0 && (
              <>
                ...
                >
                  <span>
                    {showMore ? "Hide" : "Already have a wallet? View"} options
                  </span>
                  <svg
                    width="13"
                    height="7"
