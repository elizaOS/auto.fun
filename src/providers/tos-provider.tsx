...
export default function TosProvider({ children }: PropsWithChildren) {
  ...
  return localStorageSave ? (
    ...
    <div className="h-screen w-screen grid place-items-center bg-autofun-background">
      <div className="max-w-[496px] w-full bg-autofun-background-card shadow-lg overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-white font-satoshi mb-6 text-xl">
            Here’s how it works:
          </p>
          <ol className="text-white font-satoshi text-center text-base mb-6 list-decimal list-inside">
          ...
          <button className="bg-autofun-background-action-highlight text-black px-6 py-2 hover:bg-gray-200 transition-all font-semibold">
            I'm ready to have fun
          </button>
        </div>

        <div className="border-t border-autofun-border p-4 flex justify-center gap-4 text-xs text-autofun-background-disabled">
